...
/* harmony export */ });
function renderTemplatePage(container, project) {
    ...
    addTaskBtn.addEventListener("click", () => {
      ...
      if (nameInput.value !== "") {
        if (openTab === "myDay" || openTab === "thisWeek") {
          if (dueDateBtn.value === "") {
            dueDateBtn.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), "yyyy-MM-dd");
          }
        }
...
const appLogic = (() => {
  ...
  const addTodoToDateFolder = (todo) => {
    let date = new Date(Date.parse(todo.date));
    if (date !== "") {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(date)) {
        assignTaskToFolder(todo, "myDay");
      }
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(date)) {
  ...
  const updateProject = () => {
    ...
    if (PROJECTS) {
      ...
      for (let project of PROJECTS) {
        ...
        let newFolder = (0,_template__WEBPACK_IMPORTED_MODULE_5__["default"])(content, project);
